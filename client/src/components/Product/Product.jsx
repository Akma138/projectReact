...
export default function Product({ addHandler1, inpatsHandler, inpats}) {
  console.log('product')
  ...
  return (
    ...
    <input type="image"  class="form-control"  id="img" name='img' onChange={inpatsHandler} value={inpats.img ?? ''}/>
    </div>
    <div class="mb-3">
